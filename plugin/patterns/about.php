...
<!-- wp:paragraph {"className":"cm-subtle"} --><p class="cm-subtle"><?php echo esc_html( $brand['name'] ); ?> is for the people who learned computers by doing the work. The people who know where the files are, who clean up the formatting, who rename, convert, package, extract, patch, proof, and send.</p><!-- /wp:paragraph -->
